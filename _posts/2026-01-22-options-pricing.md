...
$$
  e^{r\tau}V = \int \max(\pm F \mp K, 0)\textrm{p}(F) \mathrm{d}F
$$
...
$$
  e^{r\tau}V  = \begin{cases}
    (F-K+\mu\tau)\phi\left(\frac{F-K+\mu\tau}{\sqrt{\tau}\sigma}\right)+\sqrt{\tau}\sigma\phi'\left(\frac{F-K+\mu\tau}{\sqrt{\tau}\sigma}\right) & \quad\text{Normal}\\
    e^{\mu\tau}F \phi\left(\frac{\ln\left(\frac{F}{K}\right)+\mu\tau+\frac{1}{2}\tau\sigma^2}{\sqrt{\tau}\sigma}\right)-K \phi\left(\frac{\ln\left(\frac{F}{K}\right)+\mu\tau-\frac{1}{2}\tau\sigma^2}{\sqrt{\tau}\sigma}\right) & \quad\text{Log-Normal}
  \end{cases}
$$
...
> For the normal distribution one can partially integrate:
> 
> $$
> \begin{aligned}
>   e^{r\tau}V
...
> For the log-normal distribution one can complete the square in the exponential function:
> 
> $$
> \begin{aligned}
>   e^{r\tau}V
